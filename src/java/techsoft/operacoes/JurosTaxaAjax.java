...
@WebServlet(urlPatterns={"/JurosTaxaAjax/*"})
public class JurosTaxaAjax extends HttpServlet {
 
        private static final Logger log = Logger.getLogger("techsoft.operacoes.JurosTaxaAjax");    
        ...
        public void doGet(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException {
            ...
            if (tipo.equals("1")){
                ...
                String sql = "SELECT 1 FROM TB_JUROS_TX_ADM " +
                             "WHERE CD_TX_ADM = ? " +
                ...
                sql = "SELECT 1 FROM TB_JUROS_TX_ADM " +
                       "WHERE CD_TX_ADM = ? ";
