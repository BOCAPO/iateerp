...
@WebServlet(urlPatterns={"/EstornoAjax/*"})
public class EstornoAjax extends HttpServlet {
 
        private static final Logger log = Logger.getLogger("techsoft.caixa.EstornoAjax");    
