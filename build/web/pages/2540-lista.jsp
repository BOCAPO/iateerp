...
<body class="internas">
    ...
    <div id="titulo-subnav">Emprestimos da Academia</div>
    <div class="divisoria"></div>

    <form action="c">
        <input type="hidden" name="app" id="app" value="2540">
            ...
            <tr>
                ...
                <td>
                    <div style="margin-top: 20px; margin-left: 20px">
                        <a href="c?app=2541&acao=showForm"><img src="imagens/btn-toalhas.png" width="100" height="25" /></a><br>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <table id="tabela" style="width:98%;margin-left:15px;">
        <tbody>
            <sql:query var="rs" dataSource="jdbc/iate">
                {call SP_EMPRESTIMO_ACADEMIA ('L', ${idTipoArmario}, NULL, NULL, NULL, NULL)}
            </sql:query>                    
                   ...
                   <c:otherwise>
                      <td class="column1" align="center" style="font-size: 18px !important; vertical-align: top !important; height:93px !important; width: 100px !important; background-color: tomato">
                        ...
                        <div style="font-size:10px !important; color: black; padding-top: 10px" align="left">  
                          ...
                          <br>
                          <b>Dt. Emprestimo:</b> ${dtEmp}
                          
                            <c:if test='${row.QT_TOALHA gt 0}'>
                            <b>Toalhas Pendentes:</b> ${row.QT_TOALHA}
                          </c:if>
