...
<body class="internas">
    ...
    <c:choose>
       ...
       <c:otherwise>
            <div class="divisoria"></div>
            <div id="titulo-subnav">Empréstimo de Toalhas</div>
            <div class="divisoria"></div>
       </c:otherwise>
    </c:choose>
    ...
    <form  action="c" method="POST">
        <input type="hidden" name="app" value="2541">
        ...
        <table align="left" class="fmt">
            ...
            <c:if test='${emprestimo.id gt 0}'>
                <td>
                    ...
                    <c:if test='<%=request.isUserInRole("2545")%>'>
            ...
            <c:if test='${emprestimo.id == null}'>
                ...
                <td >
                    <p class="legendaCodigo MargemSuperior0">Qt. Toalhas</p>
        ...
        <input type="button" class="botaoVoltar"  onclick="window.location='c?app=2540'" value=" " />
    ...
    <c:if test='${armario.id == null || emprestimo.id gt 0}'>
        ...
        <sql:query var="rs" dataSource="jdbc/iate">
            ...
            FROM
                    TB_EMPRESTIMO_ACADEMIA T1,
                    TB_ITEM_EMPRESTIMO_ACADEMIA T2,
                    TB_PESSOA T3,
                    TB_CATEGORIA T4
            WHERE
            ...
            <c:if test='${emprestimo.id gt 0}'>
                AND EXISTS (SELECT 1 FROM TB_ITEM_EMPRESTIMO_ACADEMIA T0 WHERE T1.NU_SEQ_EMPRESTIMO = T0.NU_SEQ_EMPRESTIMO AND T0.NU_SEQ_EMPRESTIMO = ${emprestimo.id})
            </c:if>
