    ...
    <form action="c" method="POST">
        ...
        <table>
            <tr>
                ...
                <td>
                    <p class="legendaCodigo MargemSuperior0" >Patrimônio</p>
        ...
        <table>
            <tr>
                <td>
                    <input type="checkbox" class="legendaCodigo MargemSuperior0" name="documentacaoCompleta" value="1" <c:if test='${app == "2000"}'>disabled</c:if> <c:if test='${barco.documentacaoCompleta}'>checked</c:if>><spam class="legendaSemMargem larguraData">Documentação Completa</spam>
                </td>
                <td>
        ...
        <table>
            <tr>
                <td>
                    <p class="legendaCodigo MargemSuperior0" >Observações</p>
