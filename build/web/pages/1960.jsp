...
<body class="internas">
    ...
    <div id="titulo-subnav">Consultar Log do Internet</div>
    <div class="divisoria"></div>

    <br>

    <form action="c">
        <input type="hidden" name="app" value="1960">
        ...
        <table class="fmt" align="left" >
            <tr>
                ...
                <td >
                    ...
                    <input type="text" name="dataInicio" id="dataInicio" maxlength="10" class="campoSemTamanho alturaPadrao larguraData">
                </td>   
                <td >
                    <p class="legendaCodigo MargemSuperior0" >Data Fim:</p>
                    <input type="text" name="dataFim" id="dataFim" maxlength="10" class="campoSemTamanho alturaPadrao larguraData">
                </td>   
                <td >
