...
<body class="internas">
    ...
    <div id="titulo-subnav">Documento do Carro</div>
    <div class="divisoria"></div>


    <form action="c">
        <input type="hidden" name="idFuncionario" value="${funcionario.id}">
        <input type="hidden" name="app" value="3244">
            ...
            <tr>
                <td rowspan="4">
                    <a href="javascript: mostraDocumento(${carro.id});">
                        <img src="f?tb=9&cd=${carro.id}" onerror="this.src='images/tenis/avatar-default.png';"  class="recuoPadrao MargemSuperiorPadrao" width="120" height="160">
                    </a>
                </td>    
            </tr>    
    ...
    <form method="POST" action="upload" enctype="multipart/form-data">
        ...
        <table align="left">
           ...
           <tr>
             ...
             <td>
                 <a href="javascript: if(confirm('confirma exclusao?')) window.location.href='c?app=3244&idCarro=${carro.id}&acao=excluirFoto'"><img src="imagens/btn-excluir-foto.png" class="botaoExcluirFoto" /></a><BR>
             </td>
             <td colspan="3">
                <input type="button" class="botaoVoltar"  onclick="window.location='c?app=3240&acao=consultar&id=${carro.funcionario.id}';" value=" " />
             </td>
           </tr>
        </table>  
    </form>
