            ...
            <c:forEach var="local" items="${lista}">
                <tr height="1">
                    ...
                    <c:if test='<%=request.isUserInRole("3203")%>'>
                        <th class="column1" align="center">
                            <a href="javascript: if(confirm('Confirma a exclusão do registro selecionado?')) window.location.href='c?app=3203&id=${local.id}'"><img src="imagens/icones/inclusao-titular-05.png" /></a>
                        </th>
                    </c:if>
