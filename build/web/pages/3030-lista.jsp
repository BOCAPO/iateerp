        ...
        <c:forEach var="row" items="${rs.rows}">
            ...
            <tr height="1">
                ...
                <c:if test='<%=request.isUserInRole("3033")%>'>
                    <td class="column1" align="center">
                        <a href="javascript: if(confirm('Confirma a exclusão da turma selecionada?')) window.location.href='c?app=3033&idTurma=${row.SEQ_TURMA}'"><img src="imagens/icones/inclusao-titular-05.png" /></a>
                    </td>
                </c:if>
