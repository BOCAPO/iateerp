...
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 15px; POSITION: absolute; TOP: 197px">${s.noCedente}</DIV>
<DIV class=Campo 
...
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 15px; WIDTH: 110px; POSITION: absolute; TOP: 222px">${s.numeroDocumento}</DIV>
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 135px; WIDTH: 70px; POSITION: absolute; TOP: 222px">${contrato}</DIV>
<DIV class=Campo 
...
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 353px; WIDTH: 118px; POSITION: absolute; TOP: 222px">${dataPagamento}</DIV>
<fmt:formatNumber value="${s.valorPago}" maxFractionDigits="2" minFractionDigits="2" var="valorPago"/>
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 480px; WIDTH: 169px; POSITION: absolute; TOP: 222px; TEXT-ALIGN: right">${valorPago}</DIV>
<DIV class=Campo 
...
<DIV class=DetParcela style="Z-INDEX: 2; LEFT: 15px; WIDTH: 498px; POSITION: absolute; TOP: 405px;"><LAYER width="498px" name="helpns" align="left">
************* MAIS DETALHES ACESSE WWW.IATECLUBEDEBRASILIA.COM.BR **************<BR><BR>
</LAYER></DIV>
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 15px; POSITION: absolute; TOP: 480px">Pagável em 
qualquer Banco até o vencimento</DIV>
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 480px; WIDTH: 169px; POSITION: absolute; TOP: 480px; TEXT-ALIGN: right">${dataPagamento}</DIV>
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 15px; POSITION: absolute; TOP: 505px">${s.noCedente}</DIV>
<DIV class=Campo 
...
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 15px; WIDTH: 110px; POSITION: absolute; TOP: 530px">${dtDocumento}</DIV>
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 133px; WIDTH: 160px; POSITION: absolute; TOP: 530px">${s.numeroDocumento}</DIV>
<DIV class=Campo 
...
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 405px; WIDTH: 60px; POSITION: absolute; TOP: 530px">${dtProcessamento}</DIV>
<DIV class=Campo 
...
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 405px; WIDTH: 65px; POSITION: absolute; TOP: 556px; TEXT-ALIGN: right">${valorPago}</DIV>
<DIV class=Campo 
style="Z-INDEX: 2; LEFT: 480px; WIDTH: 169px; POSITION: absolute; TOP: 556px; TEXT-ALIGN: right">${valorPago}</DIV>
<DIV class=DetParcela  
...
<DIV class=DetParcela style="Z-INDEX: 2; LEFT: 15px; WIDTH: 498px; POSITION: absolute; TOP: 680px;"><LAYER width="498px" name="helpns" align="left">
************* MAIS DETALHES ACESSE WWW.IATECLUBEDEBRASILIA.COM.BR **************<BR><BR>
</LAYER></DIV>
