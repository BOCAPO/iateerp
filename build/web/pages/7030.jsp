...
<body class="internas">
    ...
    <div id="titulo-subnav">Mensagens</div>
    <div class="divisoria"></div>
            ...
            <tr>
                <td>
                    ...
                    <div class="selectheightnovo">
                        <select name="tipoDoc" class="campoSemTamanho alturaPadrao" style="width:180px;">
            ...
            <tbody>
                <c:forEach var="socio" items="${socios}">
                    <tr onclick="this.getElementsByTagName('input')[0].click();">
                        ...
                        <td class="column1">
                            <a href="c?app=7030&acao=detalhe&doc=${socio.nrCarteira}&tipoDoc=${tipoDoc}">
                                ${socio.nome}
                            </a>
                        </td>
