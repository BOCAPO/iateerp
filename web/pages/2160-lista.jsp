        ...
        <table id="tabela">
            ...
            <c:forEach var="marcacarro" items="${marcaCarros}">
                <tr height="1">
                    ...
                    <c:if test='<%=request.isUserInRole("2161")%>'>
                        <th class="column1" align="center">
                            <a href="javascript: if(confirm('Confirma a exclusão do registro selecionado?')) window.location.href='c?app=2163&idMarcaCarro=${marcacarro.id}'"><img src="imagens/icones/inclusao-titular-05.png" /></a>
                        </th>
                    </c:if>
