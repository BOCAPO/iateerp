...
<script type="text/javascript" language="JavaScript">    
    ...
    function validarForm(){
        ...
        if(!document.forms[0].titular.checked && !document.forms[0].dependente.checked){
            alert('Selecione pelo menos um tipo de cadastro');
            return;
        }        
...
<body class="internas">
    ...
    <div id="titulo-subnav">Relatório Simplificado do Cadastro</div>
    <div class="divisoria"></div>
    
    <form method="POST" action="c">
	<input type="hidden" name="app" value="1640">
        ...
        <table class="fmt">
            <tr>
                <td>
                    ...
                    <div class="recuoPadrao" style="overflow:auto;height:340px;width:227px;">
                ...
                <td>
                    <table class="fmt">
                        <tr>
                            <td>
                                <br>
                                <fieldset class="field-set legendaFrame recuoPadrao" style="height:50px;width:170px;">
                                    <legend >Nome:</legend>                
                                    <input type="text" name="nome" class="campoSemTamanho alturaPadrao" style="width:140px;">
                                </fieldset>
                            </td>
                        <tr>
                        </tr>
