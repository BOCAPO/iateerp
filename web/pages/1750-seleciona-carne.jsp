...
<body class="internas">
    ...
    <div class="divisoria"></div>
        <div id="titulo-subnav">Estorno Manual de Carne - Seleção</div>
    <div class="divisoria"></div>
    ...
    <form action="c">
        ...
        <table align="left">
          ...
          <tr>
            ...
            <td>
                ...
                <input type="text" name="matricula" maxlength="5" class="campoSemTamanho alturaPadrao larguraData"/>
            </td>
            <td>
        ...
        <input type="button" class="botaoVoltar"  onclick="window.location='c?app=1750';" value=" " />
