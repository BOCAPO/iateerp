...
<script type="text/javascript" language="JavaScript">
    ...
    function validarForm2(){
        window.location.href='c?app=1221'+
...
<body class="internas">
    ...
    <div id="titulo-subnav">Taxas Administrativas</div>
    <div class="divisoria"></div>
    
    <form action="c" method="POST">
        <input type="hidden" name="app" value="1220">
    ...
    <table id="tabela" style="width:98%;margin-left:15px;">
        ...
        <tbody>
            <c:forEach var="taxa" items="${taxas}">
                <tr>
                    <td class="column1" align="left">${taxa.deTaxa}</td>
                    ...
                    <c:if test='<%=request.isUserInRole("3027")%>'>
                        <th class="column1" align="center">
                            <a href="c?app=1222&acao=showForm&idCategoria=${idCategoria}&idTaxa=${taxa.taxa}&dtInicio=${dtInicio}&dtFim=${dtFim}&valor=${valor}"><img src="imagens/icones/inclusao-titular-03.png"/></a>
                        </th>
                    </c:if>
                </tr>
            </c:forEach>
