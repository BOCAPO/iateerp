...
<body class="internas">
        ...
        <div id="titulo-subnav">Armário da Academia</div>
        <div class="divisoria"></div>
            ...
            <c:forEach var="item" items="${lista}">
                <tr height="1">
                    ...
                    <c:if test='<%=request.isUserInRole("2533")%>'>
                        <th class="column1" align="center">
                            <a href="javascript: if(confirm('Confirma a exclusão do registro selecionado?')) window.location.href='c?app=2533&id=${item.id}'"><img src="imagens/icones/inclusao-titular-05.png" /></a>
                        </th>
                    </c:if>
