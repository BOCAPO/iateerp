...
<body class="internas">
        ...
        <div id="titulo-subnav">Categorias Náuticas</div>
        <div class="divisoria"></div>
            ...
            <c:forEach var="categorianautica" items="${CategoriaNauticas}">
                <tr height="1">
                    ...
                    <c:if test='<%=request.isUserInRole("1133")%>'>
                        <th class="column1" align="center">
                            <a href="javascript: if(confirm('Confirma a exclusão do registro selecionado?')) window.location.href='c?app=1133&idCategoriaNautica=${categorianautica.id}'"><img src="imagens/icones/inclusao-titular-05.png" /></a>
                        </th>
                    </c:if>
