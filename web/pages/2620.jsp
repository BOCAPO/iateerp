...
<script type="text/javascript" language="JavaScript">
    ...
    function validarForm(){
        ...
        if (document.forms[0].dataReferencia.value == ""){
            alert('Informe a Data de Utilização para pesquisa!');
            return false;
        }
        ...
        if (
            (document.forms[0].categoria.value != "" && document.forms[0].titulo.value == "") ||
            (document.forms[0].titulo.value != "" && document.forms[0].categoria.value == "")
            ){
...
<body class="internas">
    ...
    <div id="titulo-subnav">Termo de Vistoria</div>
    <div class="divisoria"></div>

    <form action="c" id="it-bloco01">

        <input type="hidden" name="app" value="2620"/>
        ...
        <table class="fmt">
            <tr>
                ...
                <td>
                    <p class="legendaCodigo MargemSuperior0" >Data Utilizacao</p> 
