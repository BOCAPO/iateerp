...
<body class="internas">
    ...
    <div id="titulo-subnav">Relatório de Créditos</div>
    <div class="divisoria"></div>
    
    <form method="POST" action="c">
	<input type="hidden" name="app" value="2470">
        ...
        <table class="fmt">
            <tr>
                <td>
                    ...
                    <div class="recuoPadrao" style="overflow:auto;height:300px;width:310px;">
                    ...
                    <table class="fmt">
                        ...
                        <tr>
                            <td>
                                ...
                                <fieldset class="field-set legendaFrame recuoPadrao" style="width:190px;height:50px;">
                                    <legend >Tipo:</legend>        
                                    &nbsp;&nbsp;<input type="radio" name="tipo" class="legendaCodigo" style="margin-top:5px" style="margin-top:5px" value="S">Por Sócio
                                    &nbsp;&nbsp;<input type="radio" name="tipo" class="legendaCodigo" style="margin-top:5px" value="T" checked>Por Taxa
                                </fieldset>
                            </td>
                        </tr>
                    </table>
