...
<body class="internas">
        ...
        <div id="titulo-subnav">Tipos de Ocorrência</div>
        <div class="divisoria"></div>
            ...
            <c:forEach var="tipoocorrencia" items="${TipoOcorrencias}">
                <tr height="1">
                    ...
                    <c:if test='<%=request.isUserInRole("2013")%>'>
                        <th class="column1" align="center">
                            <a href="javascript: if(confirm('Confirma a exclusão do registro selecionado?')) window.location.href='c?app=2013&idTipoOcorrencia=${tipoocorrencia.id}'"><img src="imagens/icones/inclusao-titular-05.png" /></a>
                        </th>
                    </c:if>
