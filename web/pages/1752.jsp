...
<body class="internas">
    ...
    <div id="titulo-subnav">Relatório de Estorno Manual</div>
    <div class="divisoria"></div>
    
    <form method="POST" action="c">
	<input type="hidden" name="app" value="1752">
	<input type="hidden" name="acao" value="visualizar">

        <fieldset class="field-set legendaFrame recuoPadrao" style="width:390px;height:50px;">
            ...
            <input type="radio" name="periodo" class="legendaCodigo" value="E">Pagamento
        </fieldset>
        <br>
