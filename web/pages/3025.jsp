...
<body class="internas">
    ...
    <div id="titulo-subnav">Juros para Taxa de Curso</div>
    <div class="divisoria"></div>
    
    <form action="c" method="POST">
        <input type="hidden" name="app" value="3025">
        ...
        <table class="fmt" align="left" >
            <tr>
              ...
              <td> &nbsp;&nbsp;&nbsp;
                <c:if test='<%=request.isUserInRole("3026")%>'>
                     <a href="c?app=3026&idCurso=${curso.id}"><img src="imagens/btn-incluir.png" style="margin-top:25px" width="100" height="25" /></a>
                </c:if>
              </td>
                ...
                <tr>
                    ...
                    <c:if test='<%=request.isUserInRole("3027")%>'>
                        <th class="column1" align="center">
                            <a href="c?app=3027&acao=showForm&idCurso=${curso.id}&dtInicio=${dtInicio}&dtFim=${dtFim}&valor=${valor}"><img src="imagens/icones/inclusao-titular-03.png"/></a>
                        </th>
                    </c:if>
                </tr>
            </c:forEach>
