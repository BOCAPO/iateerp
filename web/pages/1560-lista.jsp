        ...
        <c:forEach var="item" items="${lista}">
            <tr  height="1">
                ...
                <c:if test='<%=request.isUserInRole("1563")%>'>
                    <td class="column1" align="center">    
                        <a href="javascript: if(confirm('Confirma Exclusão de ${item.descricao} da tabela de Eventos?')) window.location.href='c?app=1563&id=${item.id}'"><img src="imagens/icones/inclusao-titular-05.png" /></a>
                    </td>
                </c:if>
